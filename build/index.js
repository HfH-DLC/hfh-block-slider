...
function Edit(_ref) {
  ...
  if (isRequesting) {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)(), "Loading...");
  }
  ...
  if (categories && categories.length > 0) {
    ...
    }, "HfH Slider"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      class: "components-placeholder__instructions"
    }, "Choose the category of the pages to be displayed in the slider."), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.SelectControl, {
      label: "Category",
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)('hfh/slider', {
  /**
   * @see ./edit.js
   */
  edit: (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.withSelect)(select => {
    ...
    return {
      ...
      isRequesting: isResolving('core', 'getEntityRecords', ['taxonomy', 'category'])
    };
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkhfh_slider"] = self["webpackChunkhfh_slider"] || [];
